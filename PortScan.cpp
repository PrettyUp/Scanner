...
BOOL CPortScan::OnInitDialog() 
{
	...
	CString	strTemp;
	char	buff[MAX_PATH];
	GetPrivateProfileString("PortScan","BeginIP","192.168.80.135",buff,MAX_PATH,INIFILENAME);
	m_ctlBeginIP.SetWindowText(buff);
	GetPrivateProfileString("PortScan","EndIP","192.168.80.136",buff,MAX_PATH,INIFILENAME);
