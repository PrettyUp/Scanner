...
BOOL CHostScan::OnInitDialog() 
{
	...
	char	buff[MAX_PATH];
	GetPrivateProfileString("Init","BeginIP","192.168.80.135",buff,MAX_PATH,INIFILENAME);
	m_ctlBeginIP.SetWindowText(buff);
	GetPrivateProfileString("Init","EndIP","192.168.80.137",buff,MAX_PATH,INIFILENAME);
